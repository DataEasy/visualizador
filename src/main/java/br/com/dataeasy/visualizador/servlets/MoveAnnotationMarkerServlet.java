...
@WebServlet(name = "MoveAnnotationMarkerServlet", urlPatterns = { "/document-annotation/MoveAnnotationMarkerHandler" })
public class MoveAnnotationMarkerServlet extends AbstractDoPostComJSONNaExcecaoAnnotationServlet {
