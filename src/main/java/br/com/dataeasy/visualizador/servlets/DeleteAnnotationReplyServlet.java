...
@WebServlet(name = "DeleteAnnotationReplyServlet", urlPatterns = { "/DeleteAnnotationReplyHandler" })
public class DeleteAnnotationReplyServlet extends AbstractDoPostComJSONNaExcecaoAnnotationServlet {
